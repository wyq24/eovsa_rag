...
class AIEnhancer:
    ...
    def _enhance_function(self, content: str, metadata: Dict) -> Dict:
        """AI enhancement for function chunks"""
        ...
        {{
            "ai_summary": "2-sentence summary of what this function does",
            "ai_purpose": "Primary purpose in telescope operations",
            "ai_dependencies": "Key dependencies and prerequisites",
            "ai_error_scenarios": ["common error conditions"],
            "ai_usage_examples": ["when this function is typically called"],
